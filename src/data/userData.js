    ...
    experience: [
        {
            ...
            role: "Full Stack Developer",
            duration: "2020-2022",
            description: "Worked on multiple projects, including a large-scale e-commerce platform and a real-time analytics dashboard."
        },
        {
            company: "DEF Agency",
            role: "Front-end Developer",
            duration: "2018-2020",
            description: "Developed and maintained multiple client websites and applications, using React and NodeJS."
        },
    ],
